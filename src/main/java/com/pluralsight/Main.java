...
public class Main {
    public static void main(String[] args) {
        ...
        //Asset asset1 = new Asset("Asset 1", "2025-10-29",1010);
        Cash savings = new Cash("Cash from refund","2025-01-01",100);
        System.out.println(" Description: " + savings.getDescription()
